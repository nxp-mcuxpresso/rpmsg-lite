...
/*
 * M71 as master/remote
 * M33S as remote/master
 */
#define RPMSG_LITE_M71_M33S_MU      NETC__MUA1__MUA
#define RPMSG_LITE_M71_M33S_MU_IRQn MU_E1_A_IRQn
...
/* VQ_ID in iMX943 is defined as follows:
...
#define RL_PLATFORM_IMX943_M71_SRTM_VRING_ID (0U)
#define RL_PLATFORM_IMX943_M71_USER_VRING_ID (1U)

#define RL_PLATFORM_IMX943_M71_A55_COM_ID (0U)
#define RL_PLATFORM_IMX943_M71_A55_SRTM_LINK_ID \
    RL_GEN_LINK_ID(RL_PLATFORM_IMX943_M71_A55_COM_ID, RL_PLATFORM_IMX943_M71_SRTM_VRING_ID)
#define RL_PLATFORM_IMX943_M71_A55_USER_LINK_ID \
    RL_GEN_LINK_ID(RL_PLATFORM_IMX943_M71_A55_COM_ID, RL_PLATFORM_IMX943_M71_USER_VRING_ID)

#define RL_PLATFORM_IMX943_M71_M33S_COM_ID (1U)
#define RL_PLATFORM_IMX943_M71_M33S_USER_LINK_ID \
    RL_GEN_LINK_ID(RL_PLATFORM_IMX943_M71_M33S_COM_ID, RL_PLATFORM_IMX943_M71_USER_VRING_ID)

#define RL_PLATFORM_IMX943_M71_M70_COM_ID (2U)
#define RL_PLATFORM_IMX943_M71_M70_USER_LINK_ID \
    RL_GEN_LINK_ID(RL_PLATFORM_IMX943_M71_M70_COM_ID, RL_PLATFORM_IMX943_M71_USER_VRING_ID)
 ...
 * cm7 core0 dtcm(cm7 core1 as master, cm7 core0 as remote):         0x20039000~0x2003A7FF(from cm7 core0 view)  = 0x20439000~0x2043A7FF(from cm7 core1, cm33 core1 view)
 * cm7 core0 dtcm(cm33 core1 as master, cm7 core0 as remote):        0x2003A800~0x2003BFFF(from cm7 core0 view)  = 0x2043A800~0x2043BFFF(from cm33 core1, cm7 core1 view)
...
/* M70 as rpmsg master, M71 as rpmsg remote, use DTCM of M71 as rpmsg share memory  */
#define RPMSG_SHMEM_M70_M71_DTCM_BEGIN_FROM_M71_VIEW (0x20039000)
#define RPMSG_SHMEM_M70_M71_DTCM_END_FROM_M71_VIEW   (0x2003A7FF)
#define RPMSG_SHMEM_M70_M71_DTCM_BEGIN_FROM_M70_VIEW (0x20339000)
#define RPMSG_SHMEM_M70_M71_DTCM_END_FROM_M70_VIEW   (0x2033A7FF)

/* M71 as rpmsg master, M70 as rpmsg remote, use DTCM of M70 as rpmsg share memory  */
#define RPMSG_SHMEM_M71_M70_DTCM_BEGIN_FROM_M71_VIEW (0x20439000)
#define RPMSG_SHMEM_M71_M70_DTCM_END_FROM_M71_VIEW   (0x2043A7FF)
#define RPMSG_SHMEM_M71_M70_DTCM_BEGIN_FROM_M70_VIEW (0x20039000)
#define RPMSG_SHMEM_M71_M70_DTCM_END_FROM_M70_VIEW   (0x2003A7FF)
...
#if defined(CONFIG_RPMSG_M70_M71) && (CONFIG_RPMSG_M70_M71)
#define RL_PLATFORM_IMX943_USER_LINK_ID RL_PLATFORM_IMX943_M71_M70_USER_LINK_ID
#define RL_PLATFORM_IMX943_SHMEM RPMSG_SHMEM_M70_M71_DTCM_BEGIN_FROM_M71_VIEW

#elif defined(CONFIG_RPMSG_M71_M70) && (CONFIG_RPMSG_M71_M70)
#define RL_PLATFORM_IMX943_USER_LINK_ID RL_PLATFORM_IMX943_M71_M70_USER_LINK_ID
#define RL_PLATFORM_IMX943_SHMEM RPMSG_SHMEM_M71_M70_DTCM_BEGIN_FROM_M71_VIEW

#elif defined(CONFIG_RPMSG_M71_M33S) && (CONFIG_RPMSG_M71_M33S)
#define RL_PLATFORM_IMX943_USER_LINK_ID RL_PLATFORM_IMX943_M71_M33S_USER_LINK_ID
#define RL_PLATFORM_IMX943_SHMEM RPMSG_SHMEM_M71_M33S_SYS_TCM_BEGIN_FROM_M71_VIEW

#elif defined(CONFIG_RPMSG_M33S_M71) && (CONFIG_RPMSG_M33S_M71)
#define RL_PLATFORM_IMX943_USER_LINK_ID RL_PLATFORM_IMX943_M71_M33S_USER_LINK_ID
#define RL_PLATFORM_IMX943_SHMEM RPMSG_SHMEM_M33S_M71_DTCM_BEGIN_FROM_M71_VIEW
#endif
