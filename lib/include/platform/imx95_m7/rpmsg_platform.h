...
#define RL_PLATFORM_IMX95_M7_A55_COM_ID (0U)

#define RL_PLATFORM_IMX95_M7_SRTM_VRING_ID (0U)
#define RL_PLATFORM_IMX95_M7_USER_VRING_ID (1U)

#define RL_PLATFORM_HIGHEST_LINK_ID RL_GEN_LINK_ID(RL_PLATFORM_IMX95_M7_A55_COM_ID, RL_PLATFORM_IMX95_M7_USER_VRING_ID)

#define RL_PLATFORM_IMX95_M7_A55_SRTM_LINK_ID \
    RL_GEN_LINK_ID(RL_PLATFORM_IMX95_M7_A55_COM_ID, RL_PLATFORM_IMX95_M7_SRTM_VRING_ID)
#define RL_PLATFORM_IMX95_M7_A55_USER_LINK_ID \
    RL_GEN_LINK_ID(RL_PLATFORM_IMX95_M7_A55_COM_ID, RL_PLATFORM_IMX95_M7_USER_VRING_ID)
