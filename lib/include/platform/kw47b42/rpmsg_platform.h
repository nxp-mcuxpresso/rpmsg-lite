...
/*
 * No need to align the VRING as defined in Linux because KW47B42 is not intended
 * to run the Linux
 */
#ifndef VRING_ALIGN
...
#define RL_PLATFORM_KW47B42_LINK_ID (0U)
...
#define RL_PLATFORM_BUFFER_COUNT_M33_M33_COM        (2U)
