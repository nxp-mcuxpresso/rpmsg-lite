 ...
 * Currently use MU1 for communication between M-Core(Cortex-M7) and A-Core(Cortex-A55)
 * Can use MU2 accoring your purpose.
 */
#define RPMSG_LITE_M7_A55_MU      MU7_MUB
#define RPMSG_LITE_M7_A55_MU_IRQn MU7_B_IRQn
...
#define RL_PLATFORM_IMX952_M7_A55_COM_ID (0U)

#define RL_PLATFORM_IMX952_M7_SRTM_VRING_ID (0U)
#define RL_PLATFORM_IMX952_M7_USER_VRING_ID (1U)

#define RL_PLATFORM_HIGHEST_LINK_ID RL_GEN_LINK_ID(RL_PLATFORM_IMX952_M7_A55_COM_ID, RL_PLATFORM_IMX952_M7_USER_VRING_ID)

#define RL_PLATFORM_IMX952_M7_A55_SRTM_LINK_ID \
    RL_GEN_LINK_ID(RL_PLATFORM_IMX952_M7_A55_COM_ID, RL_PLATFORM_IMX952_M7_SRTM_VRING_ID)
#define RL_PLATFORM_IMX952_M7_A55_USER_LINK_ID \
    RL_GEN_LINK_ID(RL_PLATFORM_IMX952_M7_A55_COM_ID, RL_PLATFORM_IMX952_M7_USER_VRING_ID)
