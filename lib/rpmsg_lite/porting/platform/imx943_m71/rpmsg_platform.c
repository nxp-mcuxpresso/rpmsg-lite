...
static int32_t isr_counter0 = 0;     /* RL_PLATFORM_IMX943_M71_M33S_USER_LINK_ID isr counter */
static int32_t isr_counter1 = 0;     /* RL_PLATFORM_IMX943_M71_M70_USER_LINK_ID isr counter */
static int32_t isr_counter2 = 0;     /* RL_PLATFORM_IMX943_M71_A55_USER_LINK_ID isr counter */

static int32_t disable_counter0 = 0; /* RL_PLATFORM_IMX943_M71_M33S_USER_LINK_ID isr counter */
static int32_t disable_counter1 = 0; /* RL_PLATFORM_IMX943_M71_M70_USER_LINK_ID isr counter */
static int32_t disable_counter2 = 0; /* RL_PLATFORM_IMX943_M71_A55_USER_LINK_ID isr counter */
...
int32_t platform_init_interrupt(uint32_t vector_id, void *isr_data)
{
    ...
    {
        case RL_PLATFORM_IMX943_M71_M33S_COM_ID:
            RL_ASSERT(0 <= isr_counter0);
            if (isr_counter0 == 0)
            {
                MU_EnableInterrupts(RPMSG_LITE_M71_M33S_MU, (uint32_t)kMU_Rx0FullInterruptEnable << RPMSG_MU_CHANNEL);
            }
            isr_counter0++;
            break;
        case RL_PLATFORM_IMX943_M71_M70_COM_ID:
            ...
            isr_counter1++;
            break;
        case RL_PLATFORM_IMX943_M71_A55_COM_ID:
...
int32_t platform_deinit_interrupt(uint32_t vector_id)
{
    ...
    switch (RL_GET_COM_ID(vector_id))
    {
        case RL_PLATFORM_IMX943_M71_M33S_COM_ID:
            ...
            if (isr_counter0 == 0)
            {
                MU_DisableInterrupts(RPMSG_LITE_M71_M33S_MU, (uint32_t)kMU_Rx0FullInterruptEnable << RPMSG_MU_CHANNEL);
            }
            break;
        case RL_PLATFORM_IMX943_M71_M70_COM_ID:
            RL_ASSERT(0 < isr_counter1);
...
void platform_notify(uint32_t vector_id)
{
    ...
    {
        case RL_PLATFORM_IMX943_M71_M33S_COM_ID:
            MU_SendMsg(RPMSG_LITE_M71_M33S_MU, RPMSG_MU_CHANNEL, msg);
            break;
        case RL_PLATFORM_IMX943_M71_M70_COM_ID:
...
int32_t MU_E1_A_IRQHandler(void)
{
    ...
    if ((((uint32_t)kMU_Rx0FullFlag << RPMSG_MU_CHANNEL) & MU_GetStatusFlags(RPMSG_LITE_M71_M33S_MU)) != 0UL)
    {
        channel = MU_ReceiveMsgNonBlocking(RPMSG_LITE_M71_M33S_MU, RPMSG_MU_CHANNEL); // Read message from RX register.
...
int32_t platform_interrupt_enable(uint32_t vector_id)
{
    ...
    switch (RL_GET_COM_ID(vector_id))
    {
        case RL_PLATFORM_IMX943_M71_M33S_COM_ID:
            ...
            {
                NVIC_EnableIRQ(RPMSG_LITE_M71_M33S_MU_IRQn);
            }
            break;
        case RL_PLATFORM_IMX943_M71_M70_COM_ID:
...
int32_t platform_interrupt_disable(uint32_t vector_id)
{
    ...
    switch (RL_GET_COM_ID(vector_id))
    {
        case RL_PLATFORM_IMX943_M71_M33S_COM_ID:
            ...
            if (disable_counter0 == 0)
            {
                NVIC_DisableIRQ(RPMSG_LITE_M71_M33S_MU_IRQn);
            }
            break;
        case RL_PLATFORM_IMX943_M71_M70_COM_ID:
            RL_ASSERT(0 <= disable_counter1);
 ...
 * Dummy implementation
 *
 * It is only used by master(when M71 as master), convert address for remote.
 */
...
void *platform_patova(uint32_t addr)
{
    ...
    /* M71 as master, M70 as remote */
    if ((addr >= RPMSG_M70_DTCM_BEGIN_FROM_M71_VIEW) && (addr <= RPMSG_M70_DTCM_END_FROM_M71_VIEW))
    {
        if ((addr >= RPMSG_SHMEM_M71_M70_DTCM_BEGIN_FROM_M71_VIEW) && (addr <= RPMSG_SHMEM_M71_M70_DTCM_END_FROM_M71_VIEW))
        {
    ...
    //   ((addr >= RPMSG_M71_DTCM_BEGIN_FROM_M33S_VIEW) && (addr <= RPMSG_M71_DTCM_END_FROM_M33S_VIEW)))
    {
        ...
        {
            /* Convert address for CM7 CORE1(M71) */
            offset = (uint32_t)((int32_t)RPMSG_M71_DTCM_BEGIN_FROM_M70_VIEW - (int32_t)RPMSG_M71_DTCM_BEGIN_FROM_M71_VIEW);
            return ((void *)(addr - offset));
        }
        if ((addr >= RPMSG_SHMEM_M33S_M71_DTCM_BEGIN_FROM_M33S_VIEW) && (addr <= RPMSG_SHMEM_M33S_M71_DTCM_END_FROM_M33S_VIEW))
        {
            /* Convert address for CM7 CORE1(M71) */
            offset = (uint32_t)((int32_t)RPMSG_M71_DTCM_BEGIN_FROM_M33S_VIEW - (int32_t)RPMSG_M71_DTCM_BEGIN_FROM_M71_VIEW);
            return ((void *)(addr - offset));
        }
	else
        {
...
{
    MU_Init(RPMSG_LITE_M71_M33S_MU);
    NVIC_SetPriority(RPMSG_LITE_M71_M33S_MU_IRQn, RPMSG_LITE_MU_IRQ_PRIORITY);
    NVIC_EnableIRQ(RPMSG_LITE_M71_M33S_MU_IRQn);
...
{
    MU_Deinit(RPMSG_LITE_M71_M33S_MU);
