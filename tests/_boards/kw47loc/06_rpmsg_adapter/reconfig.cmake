...
# KW47B42 core1 boot address (NBU core in flash)
mcux_add_configuration(
    CC "-DREMOTE_CORE_BOOT_ADDRESS=0x48800000U"
)

# NBU core1 on KW47 has a longer boot sequence via IMU transport.
...
# On KW47 the NBU (core1) is still completing rpmsg_lite_remote_init() when
# primary receives the READY event.  Without a brief delay the master_init
...
mcux_add_configuration(
    CC "-DRPMSG_MASTER_INIT_DELAY_MS=20U"
)

# Secondary core (cm33_core1) needs SH_MEM_NOT_TAKEN_FROM_LINKER because
# the KW47 core1 linker scripts do not export rpmsg shared-memory symbols
